...
print("Total of All Loans:", sum(loan_costs))

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan_cost = sum_loans / total_loans
print("Average Loan Cost:", average_loan_cost)
...
present_value = present_value_calculator(future_value, remaining_months, .2)
...
with open(output_path, "w") as LoanFile:
    csvwriter = csv.writer(LoanFile)
